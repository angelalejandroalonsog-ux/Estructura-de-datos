/*
INTENTO DE INTEGRAR COLA REDONDA EN EL TRABAJO 5.5
*/
#include <iostream>
#include <windows.h>
using namespace std;
...
void cola<T>::mostrar(){
    ...
    if (colaVacia()!=1)
    {
        ...
        if (final<frente&&final!=-1)
        {
            cout<<"final menor que frente"<<endl;
            for(i=final;i<max-1; i++)
            {
        ...
        else if(final==-1)
        {
            ...
            cout<<"caso defecto i=frente; i menor igual que final"<<endl;
